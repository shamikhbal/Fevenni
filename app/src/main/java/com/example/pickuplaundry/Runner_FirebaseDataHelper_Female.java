...
public class Runner_FirebaseDataHelper_Female {
...
//    private OrderDetail orderID=new OrderDetail();
    ...
    public Runner_FirebaseDataHelper_Female() {
        firebaseDatabase = FirebaseDatabase.getInstance();
        reff = firebaseDatabase.getReference("OrderFemale");
    }

    public void readOrders(final Runner_FirebaseDataHelper_Female.DataStatus dataStatus){
